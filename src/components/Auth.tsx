...
const Auth = () => {
  ...
  return (
    <main className="flex w-full items-center justify-center">
        <div
          className={
            'relative flex h-full w-full min-w-fit max-w-sm flex-col rounded-md border border-sky-600 bg-gradient-radial from-sky-950 via-sky800 to-sky-700 p-8 text-base text-sky-300 shadow-lg sm:h-auto sm:w-2/5'
          }
        >
          ...
          <div className="mt-2 flex">
            <span className="mx-1.5 block w-full rounded-md shadow-sm">
              <button
                ...
                className={
                  'focus:shadow-outline-sky flex w-full justify-center rounded-md border-sky-600 border-transparent bg-sky-600 px-4 py-2 text-sm font-medium text-sky-950 transition duration-150 ease-in-out hover:bg-sky-500 focus:border-sky-700 active:bg-sky-700'
                }
              >
                Sign Up
              </button>
